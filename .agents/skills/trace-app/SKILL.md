...
- User asks about **map, fog, tiles, GPS, SQLite, performance** → `.agents/skills/trace-map-engine/SKILL.md`
- User asks about **screens, styling, animation, haptics, components** → `.agents/skills/trace-ui/SKILL.md` and `.agents/skills/building-native-ui/SKILL.md`
- User asks about **icons, splash, badges, image generation** → `.agents/skills/trace-assets/SKILL.md`
